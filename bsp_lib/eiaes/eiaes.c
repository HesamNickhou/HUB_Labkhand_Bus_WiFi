...
unsigned long int ForwardTable[256] = {
...
unsigned long int LastForwardTable[256] = {
...
unsigned long int InverseTable[256] = {
...
unsigned long int LastInverseTable[256] = {
...
//===================================================================================
void ExpandAESKeyForEncryption(const unsigned char Key[16], unsigned long int ExpandedKey[44])
{
int  I, J;
unsigned long int T;
unsigned long int W0, W1, W2, W3;
  ...
  while (1)
  {
    ...
    W2 = LastForwardTable[(T >> 16)&0xFF]; W3 = LastForwardTable[(T >> 24)&0xFF];
...
//===================================================================================
void EncryptAES(const unsigned char InBuf[16], const unsigned long int  Key[44], unsigned char OutBuf[16])  
{
unsigned long int T0[4];
...
unsigned long int W0, W1, W2, W3;
  ...
  // round 1
  W0 = ForwardTable[(unsigned char)(T0[0])]; W1 = ForwardTable[(unsigned char)(T0[1] >> 8)];
  W2 = ForwardTable[(unsigned char)(T0[2] >> 16)]; W3 = ForwardTable[(unsigned char)(T0[3] >> 24)];
  T1[0] = (W0 ^ ((W1 << 8) | (W1 >> 24)) ^ ((W2 << 16) | (W2 >> 16))
    ^ ((W3 << 24) | (W3 >> 8))) ^ Key[4];
  W0 = ForwardTable[(unsigned char)(T0[1])]; W1 = ForwardTable[(unsigned char)(T0[2] >> 8)];
  W2 = ForwardTable[(unsigned char)(T0[3] >> 16)]; W3 = ForwardTable[(unsigned char)(T0[0] >> 24)];
  T1[1] = (W0 ^ ((W1 << 8) | (W1 >> 24)) ^ ((W2 << 16) | (W2 >> 16))
    ^ ((W3 << 24) | (W3 >> 8))) ^ Key[5];
  W0 = ForwardTable[(unsigned char)(T0[2])]; W1 = ForwardTable[(unsigned char)(T0[3] >> 8)];
  W2 = ForwardTable[(unsigned char)(T0[0] >> 16)]; W3 = ForwardTable[(unsigned char)(T0[1] >> 24)];
  T1[2] = (W0 ^ ((W1 << 8) | (W1 >> 24)) ^ ((W2 << 16) | (W2 >> 16))
    ^ ((W3 << 24) | (W3 >> 8))) ^ Key[6];
  W0 = ForwardTable[(unsigned char)(T0[3])]; W1 = ForwardTable[(unsigned char)(T0[0] >> 8)];
  W2 = ForwardTable[(unsigned char)(T0[1] >> 16)]; W3 = ForwardTable[(unsigned char)(T0[2] >> 24)];
  T1[3] = (W0 ^ ((W1 << 8) | (W1 >> 24)) ^ ((W2 << 16) | (W2 >> 16))
    ^ ((W3 << 24) | (W3 >> 8))) ^ Key[7];
  // round 2
  W0 = ForwardTable[(unsigned char)(T1[0])]; W1 = ForwardTable[(unsigned char)(T1[1] >> 8)];
  W2 = ForwardTable[(unsigned char)(T1[2] >> 16)]; W3 = ForwardTable[(unsigned char)(T1[3] >> 24)];
  T0[0] = (W0 ^ ((W1 << 8) | (W1 >> 24)) ^ ((W2 << 16) | (W2 >> 16))
    ^ ((W3 << 24) | (W3 >> 8))) ^ Key[8];
  W0 = ForwardTable[(unsigned char)(T1[1])]; W1 = ForwardTable[(unsigned char)(T1[2] >> 8)];
  W2 = ForwardTable[(unsigned char)(T1[3] >> 16)]; W3 = ForwardTable[(unsigned char)(T1[0] >> 24)];
  T0[1] = (W0 ^ ((W1 << 8) | (W1 >> 24)) ^ ((W2 << 16) | (W2 >> 16))
    ^ ((W3 << 24) | (W3 >> 8))) ^ Key[9];
  W0 = ForwardTable[(unsigned char)(T1[2])]; W1 = ForwardTable[(unsigned char)(T1[3] >> 8)];
  W2 = ForwardTable[(unsigned char)(T1[0] >> 16)]; W3 = ForwardTable[(unsigned char)(T1[1] >> 24)];
  T0[2] = (W0 ^ ((W1 << 8) | (W1 >> 24)) ^ ((W2 << 16) | (W2 >> 16))
    ^ ((W3 << 24) | (W3 >> 8))) ^ Key[10];
  W0 = ForwardTable[(unsigned char)(T1[3])]; W1 = ForwardTable[(unsigned char)(T1[0] >> 8)];
  W2 = ForwardTable[(unsigned char)(T1[1] >> 16)]; W3 = ForwardTable[(unsigned char)(T1[2] >> 24)];
  ...
  W0 = LastForwardTable[(unsigned char)(T1[0])]; W1 = LastForwardTable[(unsigned char)(T1[1] >> 8)];
  W2 = LastForwardTable[(unsigned char)(T1[2] >> 16)]; W3 = LastForwardTable[(unsigned char)(T1[3] >> 24)];
  T0[0] = (W0 ^ ((W1 << 8) | (W1 >> 24)) ^ ((W2 << 16) | (W2 >> 16))
    ^ ((W3 << 24) | (W3 >> 8))) ^ Key[40];
  W0 = LastForwardTable[(unsigned char)(T1[1])]; W1 = LastForwardTable[(unsigned char)(T1[2] >> 8)];
  W2 = LastForwardTable[(unsigned char)(T1[3] >> 16)]; W3 = LastForwardTable[(unsigned char)(T1[0] >> 24)];
  T0[1] = (W0 ^ ((W1 << 8) | (W1 >> 24)) ^ ((W2 << 16) | (W2 >> 16))
    ^ ((W3 << 24) | (W3 >> 8))) ^ Key[41];
  W0 = LastForwardTable[(unsigned char)(T1[2])]; W1 = LastForwardTable[(unsigned char)(T1[3] >> 8)];
  W2 = LastForwardTable[(unsigned char)(T1[0] >> 16)]; W3 = LastForwardTable[(unsigned char)(T1[1] >> 24)];
  T0[2] = (W0 ^ ((W1 << 8) | (W1 >> 24)) ^ ((W2 << 16) | (W2 >> 16))
    ^ ((W3 << 24) | (W3 >> 8))) ^ Key[42];
  W0 = LastForwardTable[(unsigned char)(T1[3])]; W1 = LastForwardTable[(unsigned char)(T1[0] >> 8)];
  W2 = LastForwardTable[(unsigned char)(T1[1] >> 16)]; W3 = LastForwardTable[(unsigned char)(T1[2] >> 24)];
  T0[3] = (W0 ^ ((W1 << 8) | (W1 >> 24)) ^ ((W2 << 16) | (W2 >> 16))
    ^ ((W3 << 24) | (W3 >> 8))) ^ Key[43];
  // finalizing   
...
//===================================================================================
void ExpandAESKeyForDecryption(unsigned long int ExpandedKey[44]) 
{
unsigned int I;
...
//===================================================================================
void ExpandAESKeyForDecryption2(const unsigned char Key[16], unsigned long int ExpandedKey[44])
{
...
//===================================================================================
void DecryptAES(const unsigned char InBuf[16], const unsigned long int Key[44], unsigned char OutBuf[16]) 
{
unsigned long int T0[4];
unsigned long int T1[4];
unsigned long int W0, W1, W2, W3;
  ...
  // round 1
  W0 = InverseTable[(unsigned char)(T0[0])]; W1 = InverseTable[(unsigned char)(T0[3] >> 8)];
  W2 = InverseTable[(unsigned char)(T0[2] >> 16)]; W3 = InverseTable[(unsigned char)(T0[1] >> 24)];
  T1[0] = (W0 ^ ((W1 << 8) | (W1 >> 24)) ^ ((W2 << 16) | (W2 >> 16))
    ^ ((W3 << 24) | (W3 >> 8))) ^ Key[36];
  W0 = InverseTable[(unsigned char)(T0[1])]; W1 = InverseTable[(unsigned char)(T0[0] >> 8)];
  W2 = InverseTable[(unsigned char)(T0[3] >> 16)]; W3 = InverseTable[(unsigned char)(T0[2] >> 24)];
  T1[1] = (W0 ^ ((W1 << 8) | (W1 >> 24)) ^ ((W2 << 16) | (W2 >> 16))
    ^ ((W3 << 24) | (W3 >> 8))) ^ Key[37];
  W0 = InverseTable[(unsigned char)(T0[2])]; W1 = InverseTable[(unsigned char)(T0[1] >> 8)];
  W2 = InverseTable[(unsigned char)(T0[0] >> 16)]; W3 = InverseTable[(unsigned char)(T0[3] >> 24)];
  T1[2] = (W0 ^ ((W1 << 8) | (W1 >> 24)) ^ ((W2 << 16) | (W2 >> 16))
    ^ ((W3 << 24) | (W3 >> 8))) ^ Key[38];
  W0 = InverseTable[(unsigned char)(T0[3])]; W1 = InverseTable[(unsigned char)(T0[2] >> 8)];
  W2 = InverseTable[(unsigned char)(T0[1] >> 16)]; W3 = InverseTable[(unsigned char)(T0[0] >> 24)];
  T1[3] = (W0 ^ ((W1 << 8) | (W1 >> 24)) ^ ((W2 << 16) | (W2 >> 16))
    ^ ((W3 << 24) | (W3 >> 8))) ^ Key[39];
  // round 2
  W0 = InverseTable[(unsigned char)(T1[0])]; W1 = InverseTable[(unsigned char)(T1[3] >> 8)];
  W2 = InverseTable[(unsigned char)(T1[2] >> 16)]; W3 = InverseTable[(unsigned char)(T1[1] >> 24)];
  T0[0] = (W0 ^ ((W1 << 8) | (W1 >> 24)) ^ ((W2 << 16) | (W2 >> 16))
    ^ ((W3 << 24) | (W3 >> 8))) ^ Key[32];
  W0 = InverseTable[(unsigned char)(T1[1])]; W1 = InverseTable[(unsigned char)(T1[0] >> 8)];
  W2 = InverseTable[(unsigned char)(T1[3] >> 16)]; W3 = InverseTable[(unsigned char)(T1[2] >> 24)];
  T0[1] = (W0 ^ ((W1 << 8) | (W1 >> 24)) ^ ((W2 << 16) | (W2 >> 16))
    ^ ((W3 << 24) | (W3 >> 8))) ^ Key[33];
  W0 = InverseTable[(unsigned char)(T1[2])]; W1 = InverseTable[(unsigned char)(T1[1] >> 8)];
  W2 = InverseTable[(unsigned char)(T1[0] >> 16)]; W3 = InverseTable[(unsigned char)(T1[3] >> 24)];
  T0[2] = (W0 ^ ((W1 << 8) | (W1 >> 24)) ^ ((W2 << 16) | (W2 >> 16))
    ^ ((W3 << 24) | (W3 >> 8))) ^ Key[34];
  W0 = InverseTable[(unsigned char)(T1[3])]; W1 = InverseTable[(unsigned char)(T1[2] >> 8)];
  W2 = InverseTable[(unsigned char)(T1[1] >> 16)]; W3 = InverseTable[(unsigned char)(T1[0] >> 24)];
  T0[3] = (W0 ^ ((W1 << 8) | (W1 >> 24)) ^ ((W2 << 16) | (W2 >> 16))
    ^ ((W3 << 24) | (W3 >> 8))) ^ Key[35];
  // round 3
  W0 = InverseTable[(unsigned char)(T0[0])]; W1 = InverseTable[(unsigned char)(T0[3] >> 8)];
  ...
  T1[3] = (W0 ^ ((W1 << 8) | (W1 >> 24)) ^ ((W2 << 16) | (W2 >> 16))
    ^ ((W3 << 24) | (W3 >> 8))) ^ Key[7];
  // last round of transformations
  W0 = LastInverseTable[(unsigned char)(T1[0])]; W1 = LastInverseTable[(unsigned char)(T1[3] >> 8)];
  W2 = LastInverseTable[(unsigned char)(T1[2] >> 16)]; W3 = LastInverseTable[(unsigned char)(T1[1] >> 24)];
  T0[0] = (W0 ^ ((W1 << 8) | (W1 >> 24)) ^ ((W2 << 16) | (W2 >> 16))
    ^ ((W3 << 24) | (W3 >> 8))) ^ Key[0];
  W0 = LastInverseTable[(unsigned char)(T1[1])]; W1 = LastInverseTable[(unsigned char)(T1[0] >> 8)];
  W2 = LastInverseTable[(unsigned char)(T1[3] >> 16)]; W3 = LastInverseTable[(unsigned char)(T1[2] >> 24)];
  T0[1] = (W0 ^ ((W1 << 8) | (W1 >> 24)) ^ ((W2 << 16) | (W2 >> 16))
    ^ ((W3 << 24) | (W3 >> 8))) ^ Key[1];
  W0 = LastInverseTable[(unsigned char)(T1[2])]; W1 = LastInverseTable[(unsigned char)(T1[1] >> 8)];
  W2 = LastInverseTable[(unsigned char)(T1[0] >> 16)]; W3 = LastInverseTable[(unsigned char)(T1[3] >> 24)];
  T0[2] = (W0 ^ ((W1 << 8) | (W1 >> 24)) ^ ((W2 << 16) | (W2 >> 16))
    ^ ((W3 << 24) | (W3 >> 8))) ^ Key[2];
  W0 = LastInverseTable[(unsigned char)(T1[3])]; W1 = LastInverseTable[(unsigned char)(T1[2] >> 8)];
  W2 = LastInverseTable[(unsigned char)(T1[1] >> 16)]; W3 = LastInverseTable[(unsigned char)(T1[0] >> 24)];
  T0[3] = (W0 ^ ((W1 << 8) | (W1 >> 24)) ^ ((W2 << 16) | (W2 >> 16))
    ^ ((W3 << 24) | (W3 >> 8))) ^ Key[3];
  // finalizing
  OutBuf[3] =(T0[0]>>24)&0xFF;
