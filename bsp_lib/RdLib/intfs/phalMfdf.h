...
/**
* \brief struct phalMfdf_DataParams_t
*
*/
typedef struct
{
...
*/
phStatus_t phalMfdf_Init(
                            phalMfdf_DataParams_t * pDataParams, /**< [In] Pointer to this layer's parameter structure. */
...
phStatus_t phalMfdf_CreateApplication(
                                      phalMfdf_DataParams_t * pDataParams,       /**< [In] Pointer to this layers param structure */
...
phStatus_t phalMfdf_GetConfig(
                              phalMfdf_DataParams_t * pDataParams,  /**< [In] Pointer to this layers parameter structure. */
