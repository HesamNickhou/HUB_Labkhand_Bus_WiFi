...
typedef struct
{
    ...
    phKeyStore_KeyEntry_t * pKeyEntries;             /**< Key entry storage, size = sizeof(#phKeyStore_KeyEntry_t) * wNumKeyEntries. */
    phKeyStore_KeyVersionPair_t * pKeyVersionPairs;  /**< Key version pairs, size = sizeof(#phKeyStore_KeyVersionPair_t)* wNumKeyEntries * wNumVersions. */
    ...
    phKeyStore_KUCEntry_t * pKUCEntries;             /**< Key usage counter entry storage, size = sizeof(#phKeyStore_KUCEntry_t) * wNumKUCEntries. */
    uint16_t wNoOfKUCEntries;                           /**< Number of Key usage counter entries. */
} phKeyStore_DataParams_t;
...
*/
phStatus_t phKeyStore_Init(
                              phKeyStore_DataParams_t * pDataParams,             /**< [In] Pointer to this layer's parameter structure. */
                              uint16_t wSizeOfDataParams,                           /**< [In] Specifies the size of the data parameter structure. */
                              phKeyStore_KeyEntry_t * pKeyEntries,               /**< [In] Pointer to a storage containing the key entries. */
                              uint16_t wNoOfKeyEntries,                             /**< [In] size of pKeyEntries. */
                              phKeyStore_KeyVersionPair_t * pKeyVersionPairs,    /**< [In] Pointer to a storage containing the key version pairs. */
                              uint16_t wNoOfVersionPairs,                           /**< [In] amount of key versions available in each key entry. */
                              phKeyStore_KUCEntry_t * pKUCEntries,               /**< [In] Key usage counter entry storage, size = sizeof(phKeyStore_KUCEntry_t) * wNumKUCEntries */
