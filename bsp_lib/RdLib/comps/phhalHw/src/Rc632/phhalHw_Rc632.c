                                  ...
                                  )
{
    ...
    uint8_t *    pTxBufferPre = NULL;
    uint16_t     wFifoBytes;
    uint16_t     wRxBufLen;
    uint16_t     wRxBufSize;
    uint8_t      bIrqWaitFor;
    uint8_t      bIrqReg = 0x00;
    uint8_t      bRegister;
    uint8_t      bError;
    ...
    while (pDataParams->wTxBufLen || wTxLength)
    {
        ...
        phhalHw_Rc632_ReadRegister(PHHAL_HW_RC632_REG_INT_REQ,&bIrqReg);
    ...
    if ((bIrqWaitFor & PHHAL_HW_RC632_BIT_TIMERIRQ) && (bIrqReg & PHHAL_HW_RC632_BIT_TIMERIRQ))
    {
        ...
        phhalHw_Rc632_ReadRegister(PHHAL_HW_RC632_REG_TIMER_CONTROL,&bRegister);
    ...
    if (status == PH_ERR_SUCCESS)
    {
        ...
        /*
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Rc632_ReadRegister(PHHAL_HW_RC632_REG_PRIMARY_STATUS, &bError));
    ...
    if (status == PH_ERR_SUCCESS)
    {
        ...
        else
        {
            ...
            phhalHw_Rc632_ReadRegister(PHHAL_HW_RC632_REG_SECONDARY_STATUS,&bRegister);
...
void phhalHw_Rc632_ReadRegister(uint8_t bAddress, uint8_t* pData)
{
unsigned char Byte;

   R_CS=0;
   Byte=spi2((bAddress<<1)|0x80);   
   Byte=spi2(0);   
   R_CS=1;
	 *pData=Byte;
...
void phhalHw_Rc632_WriteRegister(uint8_t bAddress, uint8_t bValue)
{
unsigned char Byte;
phStatus_t   statusTmp;

   R_CS=0;
   Byte=(bAddress<<1)&0x7E;
   spi2(Byte);
   spi2(bValue);
   R_CS=1;
	 statusTmp=0;
    ...
    )
{
    ...
    case PHHAL_HW_CARDTYPE_ISO14443A:
        ...
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_TXCONTROL, 0x5B); /* with 100% ASK */
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_MOD_WIDTH_SOF, 0x3F);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_TYPEB_FRAMING, 0x3B);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_BIT_PHASE, 0xA9);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_RX_CONTROL2, 0x01);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_CHANNEL_REDUND, 0x03);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_CLOCKQ_CONTROL,    0x07);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_TIMER_CONTROL,    0x06);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_MF_OUT_SELECT,    0x00);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_PRESET27,    0x63);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_CRC_PRESET_LSB,    0x63);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_CRC_PRESET_MSB,    0x63);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_TIME_SLOT_PERIOD,    0x00);
    ...
    case PHHAL_HW_CARDTYPE_ISO14443B:
        ...
        phhalHw_Rc632_WriteRegister(
            PHHAL_HW_RC632_REG_CLOCKQ_CONTROL,
            0x40);
        phhalHw_Rc632_ClearBitMask(pDataParams,
            PHHAL_HW_RC632_REG_CLOCKQ_CONTROL,
    ...
    case PHHAL_HW_CARDTYPE_ISO15693:
        ...
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_TXCONTROL, 0x48); /* standard value */
        /*phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_TXCONTROL, 0x58)); // with 100% ASK */
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_CW_COND, 0x3F);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_MOD_COND, 0x02);    /* must    be measured for    15% Modulation Index */
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_CODER_CONTROL, 0x2C);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_MOD_WIDTH, 0x3F);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_MOD_WIDTH_SOF, 0x3F);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_TYPEB_FRAMING, 0x00);

        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_RX_CONTROL1, 0x8B);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_DECODER_CONTROL, 0x00);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_BIT_PHASE, 0x52);    
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_RX_THRESHOLD, 0x66);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_BPSK_DEM_CONTROL, 0x00);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_RX_CONTROL2, 0x01);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_CLOCKQ_CONTROL, 0x00);

        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_RX_WAIT, 0x09);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_CHANNEL_REDUND, 0x0C);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_CRC_PRESET_LSB, 0xFE);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_CRC_PRESET_MSB, 0xFF);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_TIME_SLOT_PERIOD, 0x00);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_MF_OUT_SELECT, 0x02);      /* enable SIGOUT = envelope */
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_PRESET27, 0x00);                   

        /* PAGE 5  FIFO, Timer and IRQ-Pin Configuration */
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_FIFO_LEVEL, 0x20);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_TIMER_CLOCK, 0x0B);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_TIMER_CONTROL, 0x02); /* TStopRxEnd=0, TStopRxBeg=1, */
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_TIMER_RELOAD, 0x00);

        /* Flush (empty) FIFO */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Rc632_FlushFifo(pDataParams));

        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_IRQ_PIN_CONFIG, 0x03); /* interrupt active low enable */
    ...
    case PHHAL_HW_CARDTYPE_ICODEEPCUID:
        ...
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_RX_WAIT, 0x08);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_CHANNEL_REDUND, 0x0C);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_CRC_PRESET_LSB, 0xFE);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_CRC_PRESET_MSB, 0xFF);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_TIME_SLOT_PERIOD, 0x00);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_MF_OUT_SELECT, 0x02);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_PRESET27, 0x00);                   
        ...
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_IRQ_PIN_CONFIG, 0x03);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_CODER_CONTROL, 0x25);

        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_MOD_WIDTH_SOF, 0x00);

        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_RX_CONTROL1, 0x6B);

        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_DECODER_CONTROL, 0x04);

        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_BIT_PHASE, 0x92);

        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_RX_WAIT, 0x04);

        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_CHANNEL_REDUND, 0x00);

        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_TIMER_CLOCK, 0x0B);

        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_RX_THRESHOLD, 0x88);
...
{
    phStatus_t   statusTmp;
    uint8_t      bRegTimerClock;
    uint8_t      bRegTimerReload;
    uint8_t      bRegTimerControl;
    uint8_t      bTmp;
    uint16_t     wPrescaler;
    uint16_t     wReload;
    ...
    phhalHw_Rc632_ReadRegister(PHHAL_HW_RC632_REG_TIMER_CLOCK, &bRegTimerClock);
    phhalHw_Rc632_ReadRegister(PHHAL_HW_RC632_REG_TIMER_RELOAD, &bRegTimerReload);
    phhalHw_Rc632_ReadRegister(PHHAL_HW_RC632_REG_TIMER_CONTROL, &bRegTimerControl);
    ...
    do
    {
        ...
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_COMMAND, 0x00);

        /* Set new timeout value */
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_TIMER_CLOCK, (uint8_t)wPrescaler);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_TIMER_RELOAD, (uint8_t)wReload);

        /* Start the timer */
        phhalHw_Rc632_ReadRegister(PHHAL_HW_RC632_REG_CONTROL, &bTmp);
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_CONTROL, bTmp | PHHAL_HW_RC632_BIT_TSTARTNOW);

        /* wait for timer */
        do
        {
            /* Read secondary status register */
            phhalHw_Rc632_ReadRegister(PHHAL_HW_RC632_REG_SECONDARY_STATUS, &bTmp);
        }
    ...
    phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_TIMER_CLOCK, bRegTimerClock);
    phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_TIMER_RELOAD, bRegTimerReload);
    phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_TIMER_CONTROL, bRegTimerControl);
...
phStatus_t phhalHw_Rc632_SetConfig(phhalHw_Rc632_DataParams_t * pDataParams, uint16_t wConfig, uint16_t wValue)
{
    ...
    case PHHAL_HW_CONFIG_PARITY:
        ...
        phhalHw_Rc632_ReadRegister(PHHAL_HW_RC632_REG_CHANNEL_REDUND, &bBackup);
        ...
        if (bValue != bBackup)
        {
            phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_CHANNEL_REDUND, bValue);
        }
    ...
    case PHHAL_HW_CONFIG_TXLASTBITS:
        ...
        phhalHw_Rc632_ReadRegister(PHHAL_HW_RC632_REG_BIT_FRAMING, &bBackup);
        /* adjust register */
        bBackup &= (uint8_t)~(uint8_t)0x07;
        bBackup |= (uint8_t)(wValue);

        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_BIT_FRAMING, bBackup);
    ...
    case PHHAL_HW_CONFIG_RXDEAFBITS:
        ...
        phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_RX_WAIT, (uint8_t)wValue);
    ...
    case PHHAL_HW_CONFIG_CLEARBITSAFTERCOLL:
        ...
        phhalHw_Rc632_ReadRegister(PHHAL_HW_RC632_REG_DECODER_CONTROL, &bBackup);
        ...
        if (bValue != bBackup)
        {
            phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_DECODER_CONTROL, bValue);
        }
    ...
    case PHHAL_HW_CONFIG_TXDATARATE:
        ...
        if (pDataParams->bCardType == PHHAL_HW_CARDTYPE_ISO15693)
        {
            ...
            case PHHAL_HW_RF_TX_DATARATE_1_OUT_OF_256:
               phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_CODER_CONTROL, 0x2E);
               phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_DECODER_CONTROL, 0x34);
               phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_RX_WAIT, 0x09);
               phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_CHANNEL_REDUND, 0x2C);
               phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_CRC_PRESET_LSB, 0xFF);
               phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_CRC_PRESET_MSB, 0xFF);
               phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_BIT_PHASE, 0xCD);
               phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_MOD_WIDTH_SOF, 0x3F);
               phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_RX_CONTROL1, 0x8B);
               phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_RX_THRESHOLD, 0x88);
            ...
            case PHHAL_HW_RF_TX_DATARATE_1_OUT_OF_4:
               phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_CODER_CONTROL, 0x2F);
               phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_DECODER_CONTROL, 0x34);
               phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_RX_WAIT, 0x09);
               phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_CHANNEL_REDUND, 0x2C);
               phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_CRC_PRESET_LSB, 0xFF);
        ...
        else if (pDataParams->bCardType == PHHAL_HW_CARDTYPE_ISO14443A || pDataParams->bCardType == PHHAL_HW_CARDTYPE_ISO14443B)
        {
            ...
            case PHHAL_HW_RF_DATARATE_848:
                ...
                {
                   phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_CODER_CONTROL, 0x11);
                }
               phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_MOD_WIDTH, 0x13);
                /* set reader receive baudrate */
               phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_RX_CONTROL1, 0x73);
               phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_DECODER_CONTROL, 0x08);
               phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_RX_THRESHOLD, 0xEB);
               phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_BPSK_DEM_CONTROL, 0x00);
                break;
            default:
                return PH_ADD_COMPCODE(PH_ERR_INVALID_PARAMETER, PH_COMP_HAL);
        ...
        else if (pDataParams->bCardType == PHHAL_HW_CARDTYPE_ICODEEPCUID)
        {
            ...
            {
               phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_CODER_CONTROL, 0xAC);
               phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_MOD_WIDTH, 0x13);
               phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_MOD_WIDTH_SOF, 0x3F);
                /* set reader receive baudrate */
               phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_RX_CONTROL1, 0x8B);
               phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_DECODER_CONTROL, 0x60);
               phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_RX_THRESHOLD, 0xEB);
            }
            else
            {
    ...
    case PHHAL_HW_CONFIG_RXDATARATE:
        ...
        if (pDataParams->bCardType == PHHAL_HW_CARDTYPE_ISO15693)
        {
            switch (wValue)
            {
                /* Fast data-rate */
            case PHHAL_HW_RF_RX_DATARATE_FAST_HIGH:
                phhalHw_Rc632_ReadRegister(PHHAL_HW_RC632_REG_RX_CONTROL1, &bValue);
                bValue &= (uint8_t)~(uint8_t)PHHAL_HW_RC632_MASK_SUBCPULSES;
                bValue |= PHHAL_HW_RC632_BITS_SUBCPULSES_8;
               phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_RX_CONTROL1, bValue);
                break;
                /* High data-rate */
            case PHHAL_HW_RF_RX_DATARATE_HIGH:
                phhalHw_Rc632_ReadRegister(PHHAL_HW_RC632_REG_RX_CONTROL1, &bValue);
        ...
        else if (pDataParams->bCardType == PHHAL_HW_CARDTYPE_ISO14443A || pDataParams->bCardType == PHHAL_HW_CARDTYPE_ISO14443B)
        {
            ...
            case PHHAL_HW_RF_DATARATE_106:
                wOtherDataRate = pDataParams->wCfgShadow[PHHAL_HW_CONFIG_RXDATARATE];
                    phhalHw_Rc632_WriteRegister(
                    PHHAL_HW_RC632_REG_CODER_CONTROL, 0x19);
                    phhalHw_Rc632_WriteRegister(
                    PHHAL_HW_RC632_REG_MOD_WIDTH, 0x13);
                    phhalHw_Rc632_WriteRegister(
                    PHHAL_HW_RC632_REG_RX_CONTROL1, 0x73);
                    phhalHw_Rc632_WriteRegister(
                    PHHAL_HW_RC632_REG_DECODER_CONTROL, 0x08);
                    phhalHw_Rc632_WriteRegister(
                    PHHAL_HW_RC632_REG_RX_THRESHOLD, 0xEB);
                    phhalHw_Rc632_WriteRegister(
                    PHHAL_HW_RC632_REG_BPSK_DEM_CONTROL, 0x00);
                break;
            case PHHAL_HW_RF_DATARATE_212:
                wOtherDataRate = pDataParams->wCfgShadow[PHHAL_HW_CONFIG_RXDATARATE];
                    phhalHw_Rc632_WriteRegister(
                    PHHAL_HW_RC632_REG_CODER_CONTROL, 0x11);
                    phhalHw_Rc632_WriteRegister(
                    PHHAL_HW_RC632_REG_MOD_WIDTH, 0x07);
                    phhalHw_Rc632_WriteRegister(
                    PHHAL_HW_RC632_REG_RX_CONTROL1, 0x53);
                    phhalHw_Rc632_WriteRegister(
                    PHHAL_HW_RC632_REG_DECODER_CONTROL, 0x09);
                    phhalHw_Rc632_WriteRegister(
                    PHHAL_HW_RC632_REG_RX_THRESHOLD, 0xEB);
                    phhalHw_Rc632_WriteRegister(
                    PHHAL_HW_RC632_REG_BPSK_DEM_CONTROL, 0x0c);
                break;
            case PHHAL_HW_RF_DATARATE_424:
                wOtherDataRate = pDataParams->wCfgShadow[PHHAL_HW_CONFIG_RXDATARATE];
                    phhalHw_Rc632_WriteRegister(
                    PHHAL_HW_RC632_REG_CODER_CONTROL, 0x09);
                    phhalHw_Rc632_WriteRegister(
                    PHHAL_HW_RC632_REG_MOD_WIDTH, 0x03);
                    phhalHw_Rc632_WriteRegister(
                    PHHAL_HW_RC632_REG_RX_CONTROL1, 0x33);
                    phhalHw_Rc632_WriteRegister(
                    PHHAL_HW_RC632_REG_DECODER_CONTROL, 0x09);
                    phhalHw_Rc632_WriteRegister(
                    PHHAL_HW_RC632_REG_RX_THRESHOLD, 0xEB);
            ...
            case PHHAL_HW_RF_DATARATE_848:
                wOtherDataRate = pDataParams->wCfgShadow[PHHAL_HW_CONFIG_RXDATARATE];
                    phhalHw_Rc632_WriteRegister(
                    PHHAL_HW_RC632_REG_CODER_CONTROL, 0x01);
                    phhalHw_Rc632_WriteRegister(
                    PHHAL_HW_RC632_REG_MOD_WIDTH, 0x01);
                    phhalHw_Rc632_WriteRegister(
                    PHHAL_HW_RC632_REG_RX_CONTROL1, 0x13);
                    phhalHw_Rc632_WriteRegister(
                    PHHAL_HW_RC632_REG_DECODER_CONTROL, 0x09);
                    phhalHw_Rc632_WriteRegister(
                    PHHAL_HW_RC632_REG_RX_THRESHOLD, 0xEB);
    ...
    case PHHAL_HW_CONFIG_ASK100:
        ...
        phhalHw_Rc632_ReadRegister(PHHAL_HW_RC632_REG_TXCONTROL, &bValue);
       ...
       phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_TXCONTROL, bValue);
    ...
    case PHHAL_HW_CONFIG_DISABLE_MF_CRYPTO1:
        ...
        if (wValue != PH_OFF)
        {
            ...
            phhalHw_Rc632_ReadRegister(PHHAL_HW_RC632_REG_CONTROL, &bBackup);

            /* Clear Crypto1On bit */
            bBackup &= (uint8_t)~(uint8_t)PHHAL_HW_RC632_BIT_CRYPTO1ON;

            /* Write Control register */
            phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_CONTROL, bBackup);
            /* Retrieve Control register */
            phhalHw_Rc632_ReadRegister(PHHAL_HW_RC632_REG_CONTROL, &bBackup);
    ...
    case PHHAL_HW_CONFIG_SETMINFDT:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Rc632_SetMinFDT(pDataParams, wValue));
        break;
...
phStatus_t phhalHw_Rc632_GetConfig(phhalHw_Rc632_DataParams_t * pDataParams, uint16_t wConfig, uint16_t* pValue)
{
    ...
    case PHHAL_HW_CONFIG_DISABLE_MF_CRYPTO1:
        ...
        phhalHw_Rc632_ReadRegister(PHHAL_HW_RC632_REG_CONTROL, &bRegister);
    ...
    )
{
    ...
    uint16_t     wTimer = 0;
    uint16_t     wTxRate = 0;
    uint8_t      bRegTimerControl = 0;

    if (wValue == PH_ON)
    {
        /*Backup the old Timer Control values and enable the timer for FDT*/
        phhalHw_Rc632_ReadRegister(
            PHHAL_HW_RC632_REG_TIMER_CONTROL, &bRegTimerControl);
        pDataParams->bTimerControlPc = bRegTimerControl;
        bRegTimerControl = 0x06;
        phhalHw_Rc632_WriteRegister(
            PHHAL_HW_RC632_REG_TIMER_CONTROL, bRegTimerControl);
        ...
        /* Calculate values for Microsecond values */
        PH_CHECK_SUCCESS_FCT(status, phhalHw_Rc632_SetConfig(pDataParams,
        PHHAL_HW_CONFIG_TIMEOUT_VALUE_US, wTimer));
    }
    else if (wValue == PH_OFF)
    {
        phhalHw_Rc632_WriteRegister(
                PHHAL_HW_RC632_REG_TIMER_CONTROL, pDataParams->bTimerControlPc);
        PH_CHECK_SUCCESS_FCT(status, phhalHw_Rc632_SetConfig(pDataParams,
