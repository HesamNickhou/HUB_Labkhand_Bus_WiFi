                                     ...
                                     )
{
    ...
    /* start the command */
     phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_COMMAND, PHHAL_HW_RC632_CMD_CALCCRC);
    ...
    else
    {
        ...
        {
            phhalHw_Rc632_ReadRegister(PHHAL_HW_RC632_REG_CRC_RES_MSB, &bCRCRes);
            *pCrcResult = (uint16_t)bCRCRes;
            phhalHw_Rc632_ReadRegister(PHHAL_HW_RC632_REG_CRC_RES_LSB, &bCRCRes);
                                      ...
                                      )
{
    ...
    if (!(wOption & PHHAL_HW_RC632_OPTION_RXTX_TIMER_START))
    {
        ...
        bRegister &= (uint8_t)~(uint8_t)PHHAL_HW_RC632_BIT_TSTARTNOW;
         phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_CONTROL, bRegister);
    ...
    /* start the command */
     phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_COMMAND, PHHAL_HW_RC632_CMD_TRANSMIT);
                                     ...
                                     uint16_t * pRxLength)
{
    ...
    phhalHw_Rc632_ReadRegister(PHHAL_HW_RC632_REG_RX_WAIT, &bRegRxWait);
     phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_RX_WAIT, 0x3);
    ...
    /* start the command */
     phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_COMMAND, PHHAL_HW_RC632_CMD_RECEIVE);
    ...
    /* Restore RxWait setting */
     phhalHw_Rc632_WriteRegister(PHHAL_HW_RC632_REG_RX_WAIT, bRegRxWait);
