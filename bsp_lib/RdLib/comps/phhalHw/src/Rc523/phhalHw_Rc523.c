...
static const uint16_t  wRc523_DefaultShadow_I14443a[][2] =
{
...
static const uint16_t  wRc523_DefaultShadow_I14443b[][2] =
{
    {PHHAL_HW_CONFIG_PARITY,                PH_ON},
...
static const uint16_t  wRc523_DefaultShadow_Felica[][2] =
{
...
static const uint16_t  wRc523_DefaultShadow_I18092mPI[][2] =
{
    {PHHAL_HW_CONFIG_PARITY,                PH_ON},
    {PHHAL_HW_CONFIG_TXCRC,                 PH_ON},
    {PHHAL_HW_CONFIG_RXCRC,                 PH_ON},
...
static const uint16_t  wRc523_DefaultShadow_I18092mPT[][2] =
{
    {PHHAL_HW_CONFIG_PARITY,                PH_ON},
    {PHHAL_HW_CONFIG_TXCRC,                 PH_ON},
    {PHHAL_HW_CONFIG_RXCRC,                 PH_ON},
...
unsigned char Byte;
   ...
   R_CS=1;
	...
	SendByte(0x55);
	SendByte(0x55);
	SendByte(bAddress%256);
	SendByte(bAddress/256);
	SendByte(Byte);
	*/
	//printf("\n\rRead Register %X: Value: %X", bAddress, Byte);
    return PH_ADD_COMPCODE(PH_ERR_SUCCESS, PH_COMP_HAL);
}
                                   ...
                                   )
{
    ...
    uint8_t      bValue;
    uint16_t     wIndex;
    uint8_t      bModWidthReg;
    uint8_t *    pBuffer;
    uint16_t     wBufferSize;
    uint16_t     wConfigShadow;
    uint16_t *   pShadowDefault = NULL;
    uint16_t     wBufferLen = 0;
                              ...
                              )
{
    ...
    uint8_t		 bIrq0Wait;
    uint8_t		 bIrq1Wait;
    uint16_t     wTimerShift;
    uint16_t     wTimeoutNew;
    ...
    )
{
    phStatus_t   status;
    phStatus_t   statusTmp;
    uint8_t      bFifoData[6 + PHHAL_HW_MFC_KEY_LENGTH];
    uint16_t     wFifoDataLen = 0;
    uint8_t      bRegister;
    uint8_t		 bIrq1Rq;
    uint8_t      bIrq0Wait = 0x0;
    uint8_t      bIrq1Wait = 0x0;
