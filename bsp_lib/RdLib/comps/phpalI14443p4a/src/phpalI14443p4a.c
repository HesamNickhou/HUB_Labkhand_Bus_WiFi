...
phStatus_t phpalI14443p4a_Init(
                                  phpalI14443p4a_DataParams_t * pDataParams,
                                  uint16_t wSizeOfDataParams,
                                  void * pHalDataParams
                                  )
{
    if (sizeof(phpalI14443p4a_DataParams_t) != wSizeOfDataParams)
    {
    ...
    )
{
    ...
    /* Perform RATS */
    PH_CHECK_SUCCESS_FCT(statusTmp, phpalI14443p4a_Rats(pDataParams, bFsdi, bCid, pAts));

    /* Perform PPS */
    if ((bDri != PHPAL_I14443P4A_DATARATE_106) || (bDsi != PHPAL_I14443P4A_DATARATE_106))
    {
        PH_CHECK_SUCCESS_FCT(statusTmp, phpalI14443p4a_Pps(pDataParams, bDri, bDsi));
    }
