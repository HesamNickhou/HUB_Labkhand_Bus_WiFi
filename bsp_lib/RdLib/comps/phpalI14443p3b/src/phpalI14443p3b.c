...
#include "phpalI14443p3b_Int.h"

phStatus_t phpalI14443p3b_Init(
                                  phpalI14443p3b_DataParams_t * pDataParams,
                                  uint16_t wSizeOfDataParams,
                                  void * pHalDataParams
                                  )
{
    if (sizeof(phpalI14443p3b_DataParams_t) != wSizeOfDataParams)
    {
...
{
    return phpalI14443p3b_RequestBEx(pDataParams, 0, bNumSlots, bAfi, bExtAtqb, pAtqb, pAtqbLen);
}
...
{
    return phpalI14443p3b_RequestBEx(pDataParams, 1, bNumSlots, bAfi, bExtAtqb, pAtqb, pAtqbLen);
}
                                        ...
                                        )
{
    ...
    return phpalI14443p3b_CheckATQBEx( pDataParams,
        pResp,
        wRespLength,
        pAtqb,
        pAtqbLen
                                    ...
                                    )
{
    ...
    *pMbli = (uint8_t)(pResp[0] >> 4);
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phpalI14443p3b_SetReaderBaudRateEx(pDataParams));
    ...
    )
{
    ...
    *pMoreCardsAvailable = 0x00;
    ...
    /* check given DSI, DRI, FSDI */
    if (((bFsdi & ~PHPAL_I14443P3B_DATARATE_FORCE) > 8) || ((bDri & ~PHPAL_I14443P3B_DATARATE_FORCE) > 3)
    ...
    *pAtqbLen = bLocalAtqbLen;
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phpalI14443p3b_DecideBaudRateEx(pAtqb[9], &bDri, &bDsi));
...
phStatus_t phpalI14443p3b_CheckATQBEx(
    phpalI14443p3b_DataParams_t * pDataParams,
    uint8_t * pResp,
    uint16_t wRespLength,
    uint8_t * pAtqb,
...
phStatus_t phpalI14443p3b_RequestBEx(
                                        phpalI14443p3b_DataParams_t * pDataParams,
                                        uint8_t bIsWakeUp,
                                        uint8_t bNumSlots,
                                        uint8_t bAfi,
...
phStatus_t phpalI14443p3b_SetReaderBaudRateEx( phpalI14443p3b_DataParams_t * pDataParams )
{
    phStatus_t   statusTmp;
...
phStatus_t phpalI14443p3b_DecideBaudRateEx( uint8_t bBitRateCapability, uint8_t* pbDri, uint8_t* pbDsi )
{
