...
#include "phpalI14443p4_Int.h"

static const uint16_t  bI14443p4_FsTable[9] = {16, 24, 32, 40, 48, 64, 96, 128, 256};
                                 ...
                                 )
{
    ...
    return phpalI14443p4_ResetProtocol(pDataParams);
}
                                     ...
                                     )
{
    ...
    uint8_t      bIsoFrame[3];
    uint16_t     wIsoFrameLen;
    uint8_t *    pResp;
    uint16_t     wRespLen;
    uint8_t      bInvalidBlock;
    uint8_t      bResponseReceived;
    uint16_t     wRetries;

    /* Build S(DESELECT) frame */
    PH_CHECK_SUCCESS_FCT(statusTmp, phpalI14443p4_BuildSBlock(
                                      ...
                                      )
{
    phStatus_t   statusTmp;
    uint8_t      bIsoFrame[3];
    uint8_t *    pIsoFrameResp;
    uint16_t     wIsoFrameLen;

    /* Build R(NAK) frame */
    PH_CHECK_SUCCESS_FCT(statusTmp, phpalI14443p4_BuildRBlock(
        pDataParams->bCidEnabled,
        pDataParams->bCid,
    ...
    {
        PH_CHECK_SUCCESS_FCT(statusTmp, phpalI14443p4_IsValidRBlock(
            pDataParams->bCidEnabled,
            pDataParams->bCid,
            pIsoFrameResp,
            wIsoFrameLen));
                                     ...
                                     )
{
    phStatus_t   status;
    phStatus_t   statusTmp;
    uint8_t      bBufferOverflow;
    phhalHw_Rc632_DataParams_t * pParams = pDataParams->pHalDataParams;
    /* Used to build I/R/S block frames */
    uint8_t      bIsoFrame[3];
    uint16_t     wIsoFrameLen;
    uint8_t      bRxOverlapped[3];
    uint16_t     wRxOverlappedLen;
    uint16_t     wRxStartPos;
    uint8_t      bUseNad = 0;
    uint8_t      bForceSend;
    ...
    uint16_t     wMaxCardFrameSize;
    uint16_t     wPcb = 0;
    uint8_t      bRetryCountRetransmit;
    ...
    *pRxLength = 0;
    ...
    do
    {
        ...
        case PHPAL_I14443P4_SW_STATE_I_BLOCK_TX:
            ...
            {
						  	wTxBufferLen=pParams->wTxBufLen;
            ...
            */
            ...
            if (wIsoFrameLen > 0)
            {
                /* Generate I-Block frame header */
                    ...
                    bIsoFrame,
                    &wIsoFrameLen);
                //PH_CHECK_SUCCESS_FCT(statusTmp, phpalI14443p4_BuildIBlock(
                //    pDataParams->bCidEnabled,
                //    pDataParams->bCid,
                //    bUseNad,
                //    pDataParams->bNad,
        ...
        status = phpalI14443p4_IsoHandling(
            pDataParams,
...
phStatus_t phpalI14443p4_IsoHandling(
                                        phpalI14443p4_DataParams_t * pDataParams,
                                        uint16_t wOption,
                                        uint8_t bRetryCount,
                                        uint8_t * pTxBuffer,
                                        ...
                                        )
{
    ...
    uint8_t      bCheckNad;
    uint32_t     dwTimeout;
    uint16_t     wTimeoutPrev = 0;
    uint8_t      bTimeoutInMs = 0;
        ...
        if (!bInvalidBlock)
        {
            ...
            if (PHPAL_I14443P4_SW_IS_I_BLOCK(pResp[PHPAL_I14443P4_SW_PCB_POS]))
            {
                ...
                else
                {
                    ...
                    status = phpalI14443p4_IsValidIBlock(
                        pDataParams->bCidEnabled,
                        pDataParams->bCid,
                        bCheckNad,
                        pDataParams->bNad,
            ...
            else if (PHPAL_I14443P4_SW_IS_R_BLOCK(pResp[PHPAL_I14443P4_SW_PCB_POS]) && PHPAL_I14443P4_SW_IS_ACK(pResp[PHPAL_I14443P4_SW_PCB_POS]))
            {
                ...
                status = phpalI14443p4_IsValidRBlock(
                    pDataParams->bCidEnabled,
                    pDataParams->bCid,
                    pResp,
                    wRespLen);
            ...
            else if (PHPAL_I14443P4_SW_IS_S_BLOCK(pResp[PHPAL_I14443P4_SW_PCB_POS]) && PHPAL_I14443P4_SW_IS_WTX(pResp[PHPAL_I14443P4_SW_PCB_POS]))
            {
                ...
                status = phpalI14443p4_IsValidSBlock(
                    pDataParams->bCidEnabled,
                    pDataParams->bCid,
                    pResp,
                    wRespLen);
            ...
            if (bInvalidBlock)
            {
                ...
                if (pDataParams->bMaxRetryCount > 0)
                {
                    ...
                    statusTmp = phpalI14443p4_Deselect(pDataParams);
                }
...
phStatus_t phpalI14443p4_IsValidIBlock(
    uint8_t bCheckCid,
    uint8_t bCid,
    uint8_t bCheckNad,
    uint8_t bNad,
...
phStatus_t phpalI14443p4_IsValidRBlock(
    uint8_t bCheckCid,
    uint8_t bCid,
    uint8_t * pRxBuffer,
    uint16_t wRxLength
...
phStatus_t phpalI14443p4_IsValidSBlock(
    uint8_t bCheckCid,
    uint8_t bCid,
    uint8_t * pRxBuffer,
    uint16_t wRxLength
...
phStatus_t phpalI14443p4_BuildIBlock(
                                        uint8_t bCidEnabled,
                                        uint8_t bCid,
                                        uint8_t bNadEnabled,
                                        uint8_t bNad,
...
phStatus_t phpalI14443p4_BuildRBlock(
                                        uint8_t bCidEnabled,
                                        uint8_t bCid,
                                        uint8_t bPcbBlockNum,
                                        uint8_t bIsAck,
...
phStatus_t phpalI14443p4_BuildSBlock(
                                        uint8_t bCidEnabled,
                                        uint8_t bCid,
                                        uint8_t bIsWtx,
                                        uint8_t bWtxm,
