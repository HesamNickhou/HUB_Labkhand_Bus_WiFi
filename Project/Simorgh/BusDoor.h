...
typedef struct  
{
     ...
     unsigned int OldPayment;
     unsigned int Payment;
     unsigned int CurrentCoursePayment;
     unsigned int Etebar;
     unsigned char Hour, Min, Sec;
     unsigned short StartYear;
     unsigned char StartMonth, StartDay;
     unsigned char StartHour, StartMin, StartSec;
     unsigned int ElapsedTime;
     unsigned int MotionTime;
     unsigned int _MotionTime;
     unsigned int StopTime;
     unsigned int _StopTime;
     unsigned int LastStopTime;
     unsigned short ST;
     unsigned int CardPayment;
     unsigned int CashPayment;
     unsigned char Return, Khadamat;
     signed short LastCourse;
     signed short Course;
     unsigned char NumCourses;
     float SaveDistance;
     unsigned short PassengerTimer;
     unsigned char ManualStop;
		 
     unsigned int ReturnMotionTime;
     unsigned int ReturnStopTime;
     float ReturnDistance;
     unsigned int InCityMotionTime;
     unsigned int InCityStopTime;
     float InCityDistance;
     unsigned int OutCityMotionTime;
     unsigned int OutCityStopTime;
     float OutCityDistance;
     unsigned char RetHour, RetMin, RetSec;
     unsigned char OutHour, OutMin, OutSec;
     unsigned int LowSpeedMotionTime;
...
extern TPassengerInfo Passengers[MaxPassengers]; 
